    ...
    Column(
        ...
        Column(
            ...
            Column(
                ...
                // Editar Número
                RowWithIcon(label = "Editar Telefone", icon = Icons.Default.KeyboardArrowRight)
                Spacer(modifier = Modifier.width(56.dp))
                ...
                // Deletar Conta
                RowWithIcon(label = "Deletar Conta", icon = Icons.Default.KeyboardArrowRight)
            }
...
fun RowWithIcon(label: String, icon: ImageVector) {
    Row(
        ...
        modifier = Modifier
            .padding(top = 8.dp)
            .clickable {
                // Aqui você pode colocar a lógica que deseja executar quando o ícone for clicado.
                // Por exemplo, abrir uma tela de edição ou mostrar um diálogo de confirmação para excluir a conta.
            }
    ) {
        Text(
            text = label,
