...
fun Add_DispoScreen(navController: NavHostController) {
    ...
    val environments = listOf("Environment 1", "Environment 2", "Environment 3")
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(16.dp),
        ...
        if (isNewEnvironment) {
            OutlinedTextField(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(8.dp),
                placeholder = { Text(text = "Novo Ambiente") }
            )
        } else {
                ...
                Column(
                    ...
                    Box(
                        ...
                        Row(
                            ...
                            Icon(
                                painter = painterResource(id = R.drawable.baseline_keyboard_arrow_down_24), // Seu ícone aqui
                                contentDescription = null, // Adicione uma descrição adequada
                            ...
                            Text(
                                text = if (environmentName.isNotEmpty()) environmentName else "Select an environment",
                                color = Color.White,
