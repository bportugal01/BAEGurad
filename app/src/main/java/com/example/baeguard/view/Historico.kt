...
fun FireInfoCard(fireInfo: FireInfo) {
    androidx.compose.material.Card(
        ...
        Column(
            ...
            Text(text = "Temperatura: ${fireInfo.temperature}", color = Color.Black, style = androidx.compose.material.MaterialTheme.typography.body1,)
            Text(text = "Umidade: ${fireInfo.humidity}", color = Color.Black, style = androidx.compose.material.MaterialTheme.typography.body1,)
            Text(text = "Detecção de CO2: ${fireInfo.co2Detection}",  color = Color.Black, style = androidx.compose.material.MaterialTheme.typography.body1,)
            Text(text = "Tipo de Gás: ${fireInfo.gasType}", color = Color.Black, style = androidx.compose.material.MaterialTheme.typography.body1,)
        }
    }
}
@Composable
