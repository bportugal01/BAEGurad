...
sealed class NavigationItem(var route: String, var icon: Int, var title: String) {
    ...
    object Del_Conta : NavigationItem("del_conta", R.drawable.baseline_delconta_24, "Del_conta")
    object Add_dispositivo : NavigationItem("add_dispo", R.drawable.baseline_delconta_24, "Add_dispositivo")
    object Add_Qr : NavigationItem("add_qr", R.drawable.baseline_delconta_24, "Add_Qr")
